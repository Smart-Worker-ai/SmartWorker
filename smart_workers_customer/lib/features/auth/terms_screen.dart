...
const _sections = [
  ('1. Acceptance of Terms',
   'By registering or using the HAYAKU platform ("Service"), you agree to be bound by these Terms & Conditions. If you do not agree, please do not use the Service.'),
  ('2. Description of Service',
   'HAYAKU connects customers with skilled tradespeople ("Workers") for home and commercial services in Kerala. We act as a platform intermediary and do not directly employ Workers.'),
  ('3. User Eligibility',
  ...
  ('7. Limitation of Liability',
   'HAYAKU is a marketplace platform. We are not liable for the quality of services provided by Workers, property damage caused by Workers, or any indirect or consequential damages arising from use of the platform.'),
  ('8. Privacy',
