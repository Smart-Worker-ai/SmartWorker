#!/usr/bin/env bash
# Smart Workers – Firebase App Distribution deployment script
...
RELEASE_NOTES="Smart Workers Customer App v1.0 – Kerala edition. Features: Dashboard, Location search with searchable picker, Worker booking, Payment summary, Feedback."
