"""
Worker Registration backend — FastAPI entry point.

Wires CORS (env-driven allow-list, no wildcards in prod), security headers,
...
log = structlog.get_logger("worker_backend")


app = FastAPI(title="Smart Workers — Worker Portal", version="1.1.0")
...
# ── Local upload static (dev only). Production uses S3 + signed URLs. ───────
